  ...
  return (
    <form className="bg-gray-bg flex rounded-full w-[400px] h-10 md:h-[52px] items-center font-poppins mx-4 p-2.5">
      <button className="w-[10%] flex items-center justify-center">
        <CiSearch
          id="searchInput"
          className="w-6 h-6 text-body-text-color"
          type="submit"
        />
      </button>
      <input
        ...
        className="w-[90%] flex items-center p-2.5 justify-center outline-none rounded-full placeholder:text-body-text-color"
      />
    </form>
  );
};
